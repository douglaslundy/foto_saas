...
ALTER TABLE public.tenants ADD COLUMN IF NOT EXISTS banner_image_path text;
ALTER TABLE public.tenants ADD COLUMN IF NOT EXISTS banner_title text;
ALTER TABLE public.tenants ADD COLUMN IF NOT EXISTS banner_subtitle text;
ALTER TABLE public.tenants ADD COLUMN IF NOT EXISTS banner_cta_text text;
ALTER TABLE public.tenants ADD COLUMN IF NOT EXISTS banner_cta_url text;
...
ALTER TABLE public.cart_items ADD COLUMN IF NOT EXISTS id uuid NOT NULL DEFAULT gen_random_uuid();
ALTER TABLE public.cart_items ADD COLUMN IF NOT EXISTS event_id uuid REFERENCES events(id) ON DELETE CASCADE;
ALTER TABLE public.cart_items ADD COLUMN IF NOT EXISTS price_cents integer;
